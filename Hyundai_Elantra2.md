# Hyundai: ElantraSales regression:: Elantra2
bdanalytics  
...
Data: 
Source: 
    Training:   https://courses.edx.org/asset-v1:MITx+15.071x_2a+2T2015+type@asset+block/elantra.csv  
    New:        <newdt_url>  
Time period: 
...
glb_trnng_url <- "https://courses.edx.org/asset-v1:MITx+15.071x_2a+2T2015+type@asset+block/elantra.csv"
glb_newdt_url <- "<newdt_url>"
glb_out_pfx <- "Elantra2_"
...
glb_rsp_var_raw <- "ElantraSales"

# for classification, the response variable has to be a factor
glb_rsp_var <- glb_rsp_var_raw # or "ElantraSales.fctr"
...
![](Hyundai_Elantra2_files/figure-html/set_global_options-1.png) 
...
## 36     9 2011        14386          9.0     357    249.732 226.674
...
## 5      1 2014        15326          6.6     232    247.575 234.933
## 8      2 2012        13820          8.3     296    247.615 228.138
## 11     3 2010         8225          9.9     138    209.163 217.305
## 16     4 2011        22100          9.1     305    247.129 224.056
## 20     5 2011        20006          9.0     376    250.538 224.918
## 21     5 2012        18877          8.2     275    242.208 228.884
## 24     6 2011        19992          9.1     371    246.401 224.990
## 26     6 2013        22163          7.5     320    245.412 232.860
## 31     8 2010        15181          9.5     202    208.927 218.012
## 32     8 2011        15054          9.0     336    247.112 226.149
## 34     8 2013        24700          7.2     271    244.917 233.433
## 37     9 2012        18305          7.8     374    254.333 231.086
## 50    12 2013        21692          6.7     279    246.189 234.594
## 'data.frame':	15 obs. of  7 variables:
##  $ Month       : int  1 1 1 2 3 4 5 5 6 6 ...
##  $ Year        : int  2011 2013 2014 2012 2010 2011 2011 2012 2011 2013 ...
##  $ ElantraSales: int  9659 12174 15326 13820 8225 22100 20006 18877 19992 22163 ...
##  $ Unemployment: num  9.1 7.9 6.6 8.3 9.9 9.1 9 8.2 9.1 7.5 ...
##  $ Queries     : int  259 230 232 296 138 305 376 275 371 320 ...
##  $ CPI_energy  : num  229 243 248 248 209 ...
##  $ CPI_all     : num  221 231 235 228 217 ...
...
## 3      1 2012        10900          8.2     354    244.178 227.666
## 7      2 2011        12289          9.0     266    232.188 221.816
## 12     3 2011        19255          9.0     281    239.454 222.955
## 25     6 2012        17655          8.2     278    237.514 228.825
## 28     7 2011        15181          9.0     427    246.968 225.553
## 41    10 2012        14512          7.8     257    256.389 231.652
##    Month Year ElantraSales Unemployment Queries CPI_energy CPI_all
## 44    11 2011        12414          8.6     255    247.092 227.136
## 45    11 2012        15923          7.8     246    248.136 231.190
## 46    11 2013        16751          7.0     231    242.301 234.033
## 47    12 2010        13096          9.4     170    227.190 220.437
## 48    12 2011        13025          8.5     253    243.015 227.093
...
##  $ Month       : int  1 1 2 2 2 2 3 3 3 4 ...
##  $ Year        : int  2010 2012 2010 2011 2013 2014 2011 2012 2013 2010 ...
##  $ ElantraSales: int  7690 10900 7966 12289 16219 16393 19255 19681 26153 9657 ...
##  $ Unemployment: num  9.7 8.2 9.8 9 7.7 6.7 9 8.2 7.5 9.9 ...
##  $ Queries     : int  153 354 130 266 239 240 281 303 313 132 ...
##  $ CPI_energy  : num  213 244 210 232 253 ...
##  $ CPI_all     : num  217 228 217 222 233 ...
##  - attr(*, "comment")= chr "glb_trnobs_df"
```
...
```
##          label step_major step_minor   bgn   end elapsed
## 1  import.data          1          0 9.187 9.658   0.471
## 2 inspect.data          2          0 9.658    NA      NA
```
...
![](Hyundai_Elantra2_files/figure-html/inspect.data-1.png) 
...
![](Hyundai_Elantra2_files/figure-html/inspect.data-2.png) 

```
## [1] "feat: Year"
```

![](Hyundai_Elantra2_files/figure-html/inspect.data-3.png) 

```
## [1] "feat: Unemployment"
```

![](Hyundai_Elantra2_files/figure-html/inspect.data-4.png) 

```
## [1] "feat: Queries"
```

![](Hyundai_Elantra2_files/figure-html/inspect.data-5.png) 

```
## [1] "feat: CPI_energy"
```

![](Hyundai_Elantra2_files/figure-html/inspect.data-6.png) 

```
## [1] "feat: CPI_all"
```

![](Hyundai_Elantra2_files/figure-html/inspect.data-7.png) 

```
## [1] "feat: .rnorm"
```

![](Hyundai_Elantra2_files/figure-html/inspect.data-8.png) 
...
```
##          label step_major step_minor    bgn    end elapsed
## 2 inspect.data          2          0  9.658 13.417   3.759
## 3   scrub.data          2          1 13.417     NA      NA
```
...
```
##            label step_major step_minor    bgn    end elapsed
## 3     scrub.data          2          1 13.417 14.703   1.287
## 4 transform.data          2          2 14.704     NA      NA
```
...
```
##              label step_major step_minor    bgn    end elapsed
## 4   transform.data          2          2 14.704 14.757   0.053
## 5 extract.features          3          0 14.757     NA      NA
```
...
```
##                  label step_major step_minor    bgn end elapsed
## 1 extract.features_bgn          1          0 14.763  NA      NA
```
...
## 1                extract.features_bgn          1          0 14.763 14.774
## 2 extract.features_factorize.str.vars          2          0 14.775     NA
##   elapsed
## 1   0.012
## 2      NA
```
...
```
##                                 label step_major step_minor    bgn    end
## 2 extract.features_factorize.str.vars          2          0 14.775 14.789
## 3                extract.features_end          3          0 14.789     NA
##   elapsed
## 2   0.014
## 3      NA
```
...
## 2   0.014    0.014
## 1   0.012    0.011
## [1] "Total Elapsed Time: 14.789 secs"
```

![](Hyundai_Elantra2_files/figure-html/extract.features-1.png) 
...
![](Hyundai_Elantra2_files/figure-html/extract.features-2.png) 
...
```
##              label step_major step_minor    bgn    end elapsed
## 5 extract.features          3          0 14.757 15.962   1.205
## 6     cluster.data          4          0 15.962     NA      NA
```
...
```
##                 label step_major step_minor    bgn    end elapsed
## 6        cluster.data          4          0 15.962 16.341   0.379
## 7 manage.missing.data          4          1 16.341     NA      NA
```
...
```
##                 label step_major step_minor    bgn    end elapsed
## 7 manage.missing.data          4          1 16.341 16.387   0.047
## 8     select.features          5          0 16.388     NA      NA
```
...
## Year                 Year  0.72184678               0 0.72184678
## Unemployment Unemployment -0.70144444               0 0.70144444
## CPI_all           CPI_all  0.68183287               0 0.68183287
## CPI_energy     CPI_energy  0.51830652               0 0.51830652
## Queries           Queries  0.43099504               0 0.43099504
## Month               Month -0.08097804               0 0.08097804
## .rnorm             .rnorm -0.03713391               0 0.03713391
```
...
```
## [1] "cor(Unemployment, Year)=-0.9794"
## [1] "cor(ElantraSales, Unemployment)=-0.7014"
## [1] "cor(ElantraSales, Year)=0.7218"
```

```
## Warning in myfind_cor_features(feats_df = glb_feats_df, obs_df =
## glb_trnobs_df, : Identified Unemployment as highly correlated with Year
```

```
## [1] "cor(CPI_all, Year)=0.9568"
## [1] "cor(ElantraSales, CPI_all)=0.6818"
## [1] "cor(ElantraSales, Year)=0.7218"
```

```
## Warning in myfind_cor_features(feats_df = glb_feats_df, obs_df =
## glb_trnobs_df, : Identified CPI_all as highly correlated with Year
```

```
## [1] "cor(CPI_energy, Year)=0.7528"
## [1] "cor(ElantraSales, CPI_energy)=0.5183"
## [1] "cor(ElantraSales, Year)=0.7218"
```

```
## Warning in myfind_cor_features(feats_df = glb_feats_df, obs_df =
## glb_trnobs_df, : Identified CPI_energy as highly correlated with Year
```

```
##             id       cor.y exclude.as.feat  cor.y.abs cor.high.X freqRatio
## 7         Year  0.72184678               0 0.72184678       <NA>  1.111111
## 2      CPI_all  0.68183287               0 0.68183287       Year  1.000000
## 3   CPI_energy  0.51830652               0 0.51830652       Year  1.000000
## 5      Queries  0.43099504               0 0.43099504       <NA>  1.000000
## 1       .rnorm -0.03713391               0 0.03713391       <NA>  1.000000
## 4        Month -0.08097804               0 0.08097804       <NA>  1.000000
## 6 Unemployment -0.70144444               0 0.70144444       Year  1.250000
##   percentUnique zeroVar   nzv myNearZV is.cor.y.abs.low
## 7      14.28571   FALSE FALSE    FALSE            FALSE
## 2     100.00000   FALSE FALSE    FALSE            FALSE
## 3     100.00000   FALSE FALSE    FALSE            FALSE
## 5     100.00000   FALSE FALSE    FALSE            FALSE
## 1     100.00000   FALSE FALSE    FALSE            FALSE
## 4      34.28571   FALSE FALSE    FALSE            FALSE
## 6      57.14286   FALSE FALSE    FALSE            FALSE
```
...
![](Hyundai_Elantra2_files/figure-html/select.features-1.png) 
...
```
##                     label step_major step_minor    bgn    end elapsed
## 8         select.features          5          0 16.388 16.955   0.567
## 9 partition.data.training          6          0 16.955     NA      NA
```
...
```
## [1] "Newdata contains non-NA data for ElantraSales; setting OOB to Newdata"
```
...
## ElantraSales ElantraSales            TRUE    TRUE
```
...
```
##                      label step_major step_minor    bgn    end elapsed
## 9  partition.data.training          6          0 16.955 17.294   0.339
## 10              fit.models          7          0 17.294     NA      NA
```
...
![](Hyundai_Elantra2_files/figure-html/fit.models_0-1.png) ![](Hyundai_Elantra2_files/figure-html/fit.models_0-2.png) ![](Hyundai_Elantra2_files/figure-html/fit.models_0-3.png) ![](Hyundai_Elantra2_files/figure-html/fit.models_0-4.png) 
...
## -8032.4 -3027.2  -189.8  2799.3 10800.2 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)    
## (Intercept)  15513.8      837.6  18.521   <2e-16 ***
## .rnorm        -183.3      858.9  -0.213    0.832    
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 4956 on 33 degrees of freedom
## Multiple R-squared:  0.001379,	Adjusted R-squared:  -0.02888 
## F-statistic: 0.04557 on 1 and 33 DF,  p-value: 0.8323
## 
## [1] "    calling mypredict_mdl for fit:"
## [1] "    calling mypredict_mdl for OOB:"
##   model_id model_method  feats max.nTuningRuns min.elapsedtime.everything
## 1   MFO.lm           lm .rnorm               0                      0.643
##   min.elapsedtime.final max.R.sq.fit min.RMSE.fit max.R.sq.OOB
## 1                 0.003  0.001378927      4811.88  -0.01452111
##   min.RMSE.OOB max.Adj.R.sq.fit
## 1     5010.909      -0.02888232
```
...
```
## Fitting cp = 0.432 on full training set
```
...
![](Hyundai_Elantra2_files/figure-html/fit.models_0-5.png) 
...
##   mean=15514.23, MSE=2.318616e+07 
## 
## n= 35 
## 
...
![](Hyundai_Elantra2_files/figure-html/fit.models_0-6.png) 
...
## 
##          CP nsplit rel error
## 1 0.4318317      0 1.0000000
## 2 0.0000000      1 0.5681683
## 
## Variable importance
##    Year Queries 
##      63      37 
## 
## Node number 1: 35 observations,    complexity param=0.4318317
##   mean=15514.23, MSE=2.318616e+07 
##   left son=2 (17 obs) right son=3 (18 obs)
##   Primary splits:
##       Year    < 2011.5 to the left,  improve=0.4318317, (0 missing)
##       Queries < 200.5  to the left,  improve=0.3698588, (0 missing)
##   Surrogate splits:
##       Queries < 200.5  to the left,  agree=0.8, adj=0.588, (0 split)
## 
## Node number 2: 17 observations
##   mean=12258.24, MSE=1.065412e+07 
## 
## Node number 3: 18 observations
##   mean=18589.33, MSE=1.55532e+07 
## 
## n= 35 
## 
## node), split, n, deviance, yval
...
## 
## 1) root 35 811515700 15514.23  
##   2) Year< 2011.5 17 181120000 12258.24 *
##   3) Year>=2011.5 18 279957500 18589.33 *
## [1] "    calling mypredict_mdl for fit:"
## [1] "    calling mypredict_mdl for OOB:"
##                    model_id model_method         feats max.nTuningRuns
## 1 Max.cor.Y.cv.0.cp.0.rpart        rpart Year, Queries               0
##   min.elapsedtime.everything min.elapsedtime.final max.R.sq.fit
## 1                      0.428                 0.005    0.4318317
##   min.RMSE.fit max.R.sq.OOB min.RMSE.OOB
## 1     3629.551  -0.05195399     5102.516
```
...
## Fitting cp = 0.216 on full training set
```

![](Hyundai_Elantra2_files/figure-html/fit.models_0-7.png) ![](Hyundai_Elantra2_files/figure-html/fit.models_0-8.png) 
...
## [1] "    calling mypredict_mdl for OOB:"
##          model_id model_method         feats max.nTuningRuns
## 1 Max.cor.Y.rpart        rpart Year, Queries               3
##   min.elapsedtime.everything min.elapsedtime.final max.R.sq.fit
## 1                      0.947                 0.011    0.4318317
##   min.RMSE.fit max.R.sq.OOB min.RMSE.OOB max.Rsquared.fit min.RMSESD.fit
## 1     4217.601  -0.05195399     5102.516        0.3704345       527.1357
##   max.RsquaredSD.fit
## 1          0.2248842
```
...
![](Hyundai_Elantra2_files/figure-html/fit.models_0-9.png) ![](Hyundai_Elantra2_files/figure-html/fit.models_0-10.png) ![](Hyundai_Elantra2_files/figure-html/fit.models_0-11.png) ![](Hyundai_Elantra2_files/figure-html/fit.models_0-12.png) 
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -6614.9 -2073.7  -728.6  2144.0  7436.0 
## 
## Coefficients:
##               Estimate Std. Error t value Pr(>|t|)    
## (Intercept) -5.346e+06  1.101e+06  -4.858 3.01e-05 ***
## Year         2.665e+03  5.476e+02   4.866 2.94e-05 ***
## Queries      7.105e+00  8.216e+00   0.865    0.394    
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 3445 on 32 degrees of freedom
## Multiple R-squared:  0.532,	Adjusted R-squared:  0.5027 
## F-statistic: 18.19 on 2 and 32 DF,  p-value: 5.296e-06
## 
## [1] "    calling mypredict_mdl for fit:"
## [1] "    calling mypredict_mdl for OOB:"
##       model_id model_method         feats max.nTuningRuns
## 1 Max.cor.Y.lm           lm Year, Queries               1
##   min.elapsedtime.everything min.elapsedtime.final max.R.sq.fit
## 1                      0.838                 0.003    0.5319991
##   min.RMSE.fit max.R.sq.OOB min.RMSE.OOB max.Adj.R.sq.fit max.Rsquared.fit
## 1     3826.095     0.202488     4442.778        0.5027491        0.4988853
##   min.RMSESD.fit max.RsquaredSD.fit
## 1       181.6107         0.01754019
```
...
## [1] "    indep_vars: Year, Queries, Year:Year"
## Aggregating results
## Fitting final model on full training set
```

![](Hyundai_Elantra2_files/figure-html/fit.models_0-13.png) ![](Hyundai_Elantra2_files/figure-html/fit.models_0-14.png) ![](Hyundai_Elantra2_files/figure-html/fit.models_0-15.png) ![](Hyundai_Elantra2_files/figure-html/fit.models_0-16.png) 
...
## [1] "    indep_vars: Year, Queries, .rnorm, Month"
## Aggregating results
## Fitting final model on full training set
```

![](Hyundai_Elantra2_files/figure-html/fit.models_0-17.png) ![](Hyundai_Elantra2_files/figure-html/fit.models_0-18.png) ![](Hyundai_Elantra2_files/figure-html/fit.models_0-19.png) ![](Hyundai_Elantra2_files/figure-html/fit.models_0-20.png) 
...
## Residuals:
##    Min     1Q Median     3Q    Max 
##  -6603  -2120   -770   2132   7500 
## 
## Coefficients:
##               Estimate Std. Error t value Pr(>|t|)    
## (Intercept) -5.381e+06  1.158e+06  -4.646 6.31e-05 ***
## Year         2.682e+03  5.762e+02   4.655 6.17e-05 ***
## Queries      6.930e+00  8.535e+00   0.812    0.423    
## .rnorm       1.221e+02  6.248e+02   0.195    0.846    
## Month        5.929e+00  1.713e+02   0.035    0.973    
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 3556 on 30 degrees of freedom
## Multiple R-squared:  0.5326,	Adjusted R-squared:  0.4703 
## F-statistic: 8.546 on 4 and 30 DF,  p-value: 9.979e-05
## 
## [1] "    calling mypredict_mdl for fit:"
## [1] "    calling mypredict_mdl for OOB:"
##       model_id model_method                        feats max.nTuningRuns
## 1 Low.cor.X.lm           lm Year, Queries, .rnorm, Month               1
##   min.elapsedtime.everything min.elapsedtime.final max.R.sq.fit
## 1                      0.815                 0.003     0.532598
##   min.RMSE.fit max.R.sq.OOB min.RMSE.OOB max.Adj.R.sq.fit max.Rsquared.fit
## 1     3887.762    0.2092587     4423.879        0.4702777        0.4733632
##   min.RMSESD.fit max.RsquaredSD.fit
## 1       145.9655         0.05452525
```
...
```
##         label step_major step_minor    bgn    end elapsed
## 10 fit.models          7          0 17.294 31.408  14.114
## 11 fit.models          7          1 31.409     NA      NA
```
...
```
##              label step_major step_minor    bgn end elapsed
## 1 fit.models_1_bgn          1          0 33.082  NA      NA
```
...
```
##              label step_major step_minor    bgn    end elapsed
## 1 fit.models_1_bgn          1          0 33.082 33.094   0.012
## 2  fit.models_1_lm          2          0 33.095     NA      NA
## [1] "fitting model: All.X.lm"
## [1] "    indep_vars: Year, CPI_all, CPI_energy, Queries, .rnorm, Month, Unemployment"
## Aggregating results
## Fitting final model on full training set
```

![](Hyundai_Elantra2_files/figure-html/fit.models_1-1.png) ![](Hyundai_Elantra2_files/figure-html/fit.models_1-2.png) ![](Hyundai_Elantra2_files/figure-html/fit.models_1-3.png) ![](Hyundai_Elantra2_files/figure-html/fit.models_1-4.png) 
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -6490.9 -1946.7  -483.1  2241.7  6402.7 
## 
## Coefficients:
##                Estimate Std. Error t value Pr(>|t|)
## (Intercept)  -1.367e+07  1.347e+07  -1.015    0.319
## Year          6.903e+03  6.823e+03   1.012    0.321
## CPI_all      -9.082e+02  1.726e+03  -0.526    0.603
## CPI_energy   -2.151e+01  1.908e+02  -0.113    0.911
## Queries       1.884e+01  1.286e+01   1.465    0.155
## .rnorm       -6.217e+01  7.188e+02  -0.086    0.932
## Month         3.562e+02  5.069e+02   0.703    0.488
## Unemployment -7.529e+01  5.429e+03  -0.014    0.989
## 
## Residual standard error: 3623 on 27 degrees of freedom
## Multiple R-squared:  0.5633,	Adjusted R-squared:  0.4501 
## F-statistic: 4.975 on 7 and 27 DF,  p-value: 0.001032
## 
## [1] "    calling mypredict_mdl for fit:"
## [1] "    calling mypredict_mdl for OOB:"
...
## 1 All.X.lm           lm
##                                                             feats
## 1 Year, CPI_all, CPI_energy, Queries, .rnorm, Month, Unemployment
##   max.nTuningRuns min.elapsedtime.everything min.elapsedtime.final
## 1               1                      0.808                 0.003
##   max.R.sq.fit min.RMSE.fit max.R.sq.OOB min.RMSE.OOB max.Adj.R.sq.fit
## 1    0.5632775     4655.075    0.2053353      4434.84        0.4500531
##   max.Rsquared.fit min.RMSESD.fit max.RsquaredSD.fit
## 1        0.3221088       1043.603          0.2214563
##              label step_major step_minor    bgn    end elapsed
## 2  fit.models_1_lm          2          0 33.095 35.241   2.146
## 3 fit.models_1_glm          3          0 35.242     NA      NA
...
![](Hyundai_Elantra2_files/figure-html/fit.models_1-5.png) ![](Hyundai_Elantra2_files/figure-html/fit.models_1-6.png) ![](Hyundai_Elantra2_files/figure-html/fit.models_1-7.png) 
...
## Unemployment -7.529e+01  5.429e+03  -0.014    0.989
## 
## (Dispersion parameter for gaussian family taken to be 13126192)
## 
##     Null deviance: 811515746  on 34  degrees of freedom
## Residual deviance: 354407197  on 27  degrees of freedom
## AIC: 681.9
## 
...
## 1    0.5632775     4655.075    0.2053353      4434.84     681.897
##   max.Rsquared.fit min.RMSESD.fit max.RsquaredSD.fit
## 1        0.3221088       1043.603          0.2214563
##                   label step_major step_minor    bgn    end elapsed
## 3      fit.models_1_glm          3          0 35.242 37.508   2.266
## 4 fit.models_1_bayesglm          4          0 37.508     NA      NA
...
## 
## Working directory is /Users/bbalaji-2012/Documents/Work/Courses/MIT/Analytics_Edge_15_071x/Assignments/HW2_Hyundai_Elantra_Sales
```
...
## Deviance Residuals: 
##     Min       1Q   Median       3Q      Max  
## -6528.0  -2035.6   -540.4   2276.6   6412.0  
## 
## Coefficients:
##                Estimate Std. Error t value Pr(>|t|)
## (Intercept)  -1.200e+07  1.253e+07  -0.958    0.347
## Year          6.057e+03  6.351e+03   0.954    0.349
## CPI_all      -7.303e+02  1.643e+03  -0.445    0.660
## CPI_energy   -3.827e+01  1.842e+02  -0.208    0.837
## Queries       1.867e+01  1.281e+01   1.457    0.157
## .rnorm       -3.522e+01  7.124e+02  -0.049    0.961
## Month         2.976e+02  4.784e+02   0.622    0.539
## Unemployment -2.693e+02  5.157e+03  -0.052    0.959
## 
## (Dispersion parameter for gaussian family taken to be 13133698)
## 
##     Null deviance: 811515746  on 34  degrees of freedom
## Residual deviance: 354609835  on 27  degrees of freedom
## AIC: 681.92
## 
...
## 1               1                      1.338                 0.018
##   max.R.sq.fit min.RMSE.fit max.R.sq.OOB min.RMSE.OOB min.aic.fit
## 1    0.5630278     4459.619    0.2049852     4435.817     681.917
##   max.Rsquared.fit min.RMSESD.fit max.RsquaredSD.fit
## 1        0.3442146       806.2648           0.204026
##                   label step_major step_minor    bgn    end elapsed
## 4 fit.models_1_bayesglm          4          0 37.508 39.693   2.185
## 5    fit.models_1_rpart          5          0 39.694     NA      NA
## [1] "fitting model: All.X.no.rnorm.rpart"
## [1] "    indep_vars: Year, CPI_all, CPI_energy, Queries, Month, Unemployment"
```
...
![](Hyundai_Elantra2_files/figure-html/fit.models_1-8.png) 

```
## Aggregating results
## Selecting tuning parameters
## Fitting cp = 0.253 on full training set
```

![](Hyundai_Elantra2_files/figure-html/fit.models_1-9.png) 
...
## 
##         CP nsplit rel error
## 1 0.506829      0  1.000000
## 2 0.000000      1  0.493171
## 
## Variable importance
##      CPI_all Unemployment         Year   CPI_energy      Queries 
##           25           23           23           14           13 
##        Month 
##            1 
## 
## Node number 1: 35 observations,    complexity param=0.506829
##   mean=15514.23, MSE=2.318616e+07 
##   left son=2 (18 obs) right son=3 (17 obs)
##   Primary splits:
##       CPI_all      < 228.199  to the left,  improve=0.5068290, (0 missing)
##       Unemployment < 8.35     to the right, improve=0.4318317, (0 missing)
##       Year         < 2011.5   to the left,  improve=0.4318317, (0 missing)
##       CPI_energy   < 233.4725 to the left,  improve=0.4007377, (0 missing)
##       Queries      < 200.5    to the left,  improve=0.3698588, (0 missing)
##   Surrogate splits:
##       Year         < 2011.5   to the left,  agree=0.971, adj=0.941, (0 split)
##       Unemployment < 8.35     to the right, agree=0.971, adj=0.941, (0 split)
##       CPI_energy   < 233.4725 to the left,  agree=0.800, adj=0.588, (0 split)
##       Queries      < 200.5    to the left,  agree=0.771, adj=0.529, (0 split)
##       Month        < 1.5      to the left,  agree=0.543, adj=0.059, (0 split)
## 
## Node number 2: 18 observations
##   mean=12182.78, MSE=1.015902e+07 
## 
## Node number 3: 17 observations
##   mean=19041.65, MSE=1.278551e+07 
## 
## n= 35 
## 
## node), split, n, deviance, yval
...
## 
## 1) root 35 811515700 15514.23  
##   2) CPI_all< 228.199 18 182862300 12182.78 *
##   3) CPI_all>=228.199 17 217353700 19041.65 *
## [1] "    calling mypredict_mdl for fit:"
## [1] "    calling mypredict_mdl for OOB:"
##               model_id model_method
## 1 All.X.no.rnorm.rpart        rpart
##                                                     feats max.nTuningRuns
## 1 Year, CPI_all, CPI_energy, Queries, Month, Unemployment               3
##   min.elapsedtime.everything min.elapsedtime.final max.R.sq.fit
## 1                      1.001                 0.007     0.506829
##   min.RMSE.fit max.R.sq.OOB min.RMSE.OOB max.Rsquared.fit min.RMSESD.fit
## 1     4275.064 -0.004208898     4985.377        0.3704345       409.5943
##   max.RsquaredSD.fit
## 1          0.2248842
##                label step_major step_minor    bgn    end elapsed
## 5 fit.models_1_rpart          5          0 39.694 42.483   2.789
## 6    fit.models_1_rf          6          0 42.484     NA      NA
...
![](Hyundai_Elantra2_files/figure-html/fit.models_1-10.png) 
...
![](Hyundai_Elantra2_files/figure-html/fit.models_1-11.png) ![](Hyundai_Elantra2_files/figure-html/fit.models_1-12.png) 
...
## 1 Year, CPI_all, CPI_energy, Queries, Month, Unemployment               3
##   min.elapsedtime.everything min.elapsedtime.final max.R.sq.fit
## 1                       1.01                 0.022    0.8983158
##   min.RMSE.fit max.R.sq.OOB min.RMSE.OOB max.Rsquared.fit min.RMSESD.fit
## 1     3502.873     0.501729     3500.517        0.6203721       525.8131
##   max.RsquaredSD.fit
## 1         0.09241178
```
...
##                                                                                     feats
## MFO.lm                                                                             .rnorm
## Max.cor.Y.cv.0.rpart                                                        Year, Queries
## Max.cor.Y.cv.0.cp.0.rpart                                                   Year, Queries
## Max.cor.Y.rpart                                                             Year, Queries
## Max.cor.Y.lm                                                                Year, Queries
## Interact.High.cor.Y.lm                                           Year, Queries, Year:Year
## Low.cor.X.lm                                                 Year, Queries, .rnorm, Month
## All.X.lm                  Year, CPI_all, CPI_energy, Queries, .rnorm, Month, Unemployment
## All.X.glm                 Year, CPI_all, CPI_energy, Queries, .rnorm, Month, Unemployment
## All.X.bayesglm            Year, CPI_all, CPI_energy, Queries, .rnorm, Month, Unemployment
## All.X.no.rnorm.rpart              Year, CPI_all, CPI_energy, Queries, Month, Unemployment
## All.X.no.rnorm.rf                 Year, CPI_all, CPI_energy, Queries, Month, Unemployment
##                           max.nTuningRuns min.elapsedtime.everything
## MFO.lm                                  0                      0.643
## Max.cor.Y.cv.0.rpart                    0                      0.563
## Max.cor.Y.cv.0.cp.0.rpart               0                      0.428
## Max.cor.Y.rpart                         3                      0.947
## Max.cor.Y.lm                            1                      0.838
## Interact.High.cor.Y.lm                  1                      0.841
## Low.cor.X.lm                            1                      0.815
## All.X.lm                                1                      0.808
## All.X.glm                               1                      0.850
## All.X.bayesglm                          1                      1.338
## All.X.no.rnorm.rpart                    3                      1.001
## All.X.no.rnorm.rf                       3                      1.010
##                           min.elapsedtime.final max.R.sq.fit min.RMSE.fit
## MFO.lm                                    0.003  0.001378927     4811.880
## Max.cor.Y.cv.0.rpart                      0.008  0.000000000     4815.201
## Max.cor.Y.cv.0.cp.0.rpart                 0.005  0.431831689     3629.551
## Max.cor.Y.rpart                           0.011  0.431831689     4217.601
## Max.cor.Y.lm                              0.003  0.531999121     3826.095
## Interact.High.cor.Y.lm                    0.002  0.531999121     3826.095
## Low.cor.X.lm                              0.003  0.532598001     3887.762
## All.X.lm                                  0.003  0.563277486     4655.075
## All.X.glm                                 0.008  0.563277486     4655.075
## All.X.bayesglm                            0.018  0.563027782     4459.619
## All.X.no.rnorm.rpart                      0.007  0.506829031     4275.064
## All.X.no.rnorm.rf                         0.022  0.898315843     3502.873
##                           max.R.sq.OOB min.RMSE.OOB max.Adj.R.sq.fit
## MFO.lm                    -0.014521109     5010.909      -0.02888232
## Max.cor.Y.cv.0.rpart       0.000000000     4974.919               NA
## Max.cor.Y.cv.0.cp.0.rpart -0.051953987     5102.516               NA
## Max.cor.Y.rpart           -0.051953987     5102.516               NA
## Max.cor.Y.lm               0.202487973     4442.778       0.50274907
## Interact.High.cor.Y.lm     0.202487973     4442.778       0.50274907
## Low.cor.X.lm               0.209258716     4423.879       0.47027773
## All.X.lm                   0.205335298     4434.840       0.45005313
## All.X.glm                  0.205335298     4434.840               NA
## All.X.bayesglm             0.204985204     4435.817               NA
## All.X.no.rnorm.rpart      -0.004208898     4985.377               NA
## All.X.no.rnorm.rf          0.501728951     3500.517               NA
##                           max.Rsquared.fit min.RMSESD.fit
## MFO.lm                                  NA             NA
## Max.cor.Y.cv.0.rpart                    NA             NA
## Max.cor.Y.cv.0.cp.0.rpart               NA             NA
## Max.cor.Y.rpart                  0.3704345       527.1357
## Max.cor.Y.lm                     0.4988853       181.6107
## Interact.High.cor.Y.lm           0.4988853       181.6107
## Low.cor.X.lm                     0.4733632       145.9655
## All.X.lm                         0.3221088      1043.6030
## All.X.glm                        0.3221088      1043.6030
## All.X.bayesglm                   0.3442146       806.2648
## All.X.no.rnorm.rpart             0.3704345       409.5943
## All.X.no.rnorm.rf                0.6203721       525.8131
##                           max.RsquaredSD.fit min.aic.fit
## MFO.lm                                    NA          NA
## Max.cor.Y.cv.0.rpart                      NA          NA
## Max.cor.Y.cv.0.cp.0.rpart                 NA          NA
## Max.cor.Y.rpart                   0.22488417          NA
## Max.cor.Y.lm                      0.01754019          NA
## Interact.High.cor.Y.lm            0.01754019          NA
## Low.cor.X.lm                      0.05452525          NA
## All.X.lm                          0.22145631          NA
## All.X.glm                         0.22145631     681.897
## All.X.bayesglm                    0.20402605     681.917
## All.X.no.rnorm.rpart              0.22488417          NA
## All.X.no.rnorm.rf                 0.09241178          NA
```
...
```
##              label step_major step_minor    bgn    end elapsed
## 6  fit.models_1_rf          6          0 42.484 44.962   2.478
## 7 fit.models_1_end          7          0 44.962     NA      NA
```
...
```
##         label step_major step_minor    bgn    end elapsed
## 11 fit.models          7          1 31.409 44.968  13.559
## 12 fit.models          7          2 44.968     NA      NA
```
...
## MFO.lm                                  0  0.001378927 -0.014521109
## Max.cor.Y.cv.0.rpart                    0  0.000000000  0.000000000
## Max.cor.Y.cv.0.cp.0.rpart               0  0.431831689 -0.051953987
## Max.cor.Y.rpart                         3  0.431831689 -0.051953987
## Max.cor.Y.lm                            1  0.531999121  0.202487973
## Interact.High.cor.Y.lm                  1  0.531999121  0.202487973
## Low.cor.X.lm                            1  0.532598001  0.209258716
## All.X.lm                                1  0.563277486  0.205335298
## All.X.glm                               1  0.563277486  0.205335298
## All.X.bayesglm                          1  0.563027782  0.204985204
## All.X.no.rnorm.rpart                    3  0.506829031 -0.004208898
## All.X.no.rnorm.rf                       3  0.898315843  0.501728951
##                           max.Adj.R.sq.fit max.Rsquared.fit
## MFO.lm                         -0.02888232               NA
## Max.cor.Y.cv.0.rpart                    NA               NA
## Max.cor.Y.cv.0.cp.0.rpart               NA               NA
## Max.cor.Y.rpart                         NA        0.3704345
## Max.cor.Y.lm                    0.50274907        0.4988853
## Interact.High.cor.Y.lm          0.50274907        0.4988853
## Low.cor.X.lm                    0.47027773        0.4733632
## All.X.lm                        0.45005313        0.3221088
## All.X.glm                               NA        0.3221088
## All.X.bayesglm                          NA        0.3442146
## All.X.no.rnorm.rpart                    NA        0.3704345
## All.X.no.rnorm.rf                       NA        0.6203721
##                           inv.elapsedtime.everything inv.elapsedtime.final
## MFO.lm                                     1.5552100             333.33333
## Max.cor.Y.cv.0.rpart                       1.7761989             125.00000
## Max.cor.Y.cv.0.cp.0.rpart                  2.3364486             200.00000
## Max.cor.Y.rpart                            1.0559662              90.90909
## Max.cor.Y.lm                               1.1933174             333.33333
## Interact.High.cor.Y.lm                     1.1890606             500.00000
## Low.cor.X.lm                               1.2269939             333.33333
## All.X.lm                                   1.2376238             333.33333
## All.X.glm                                  1.1764706             125.00000
## All.X.bayesglm                             0.7473842              55.55556
## All.X.no.rnorm.rpart                       0.9990010             142.85714
## All.X.no.rnorm.rf                          0.9900990              45.45455
##                           inv.RMSE.fit inv.RMSE.OOB inv.aic.fit
## MFO.lm                    0.0002078190 0.0001995646          NA
## Max.cor.Y.cv.0.rpart      0.0002076756 0.0002010083          NA
## Max.cor.Y.cv.0.cp.0.rpart 0.0002755161 0.0001959817          NA
## Max.cor.Y.rpart           0.0002371016 0.0001959817          NA
## Max.cor.Y.lm              0.0002613631 0.0002250844          NA
## Interact.High.cor.Y.lm    0.0002613631 0.0002250844          NA
## Low.cor.X.lm              0.0002572174 0.0002260460          NA
## All.X.lm                  0.0002148193 0.0002254873          NA
## All.X.glm                 0.0002148193 0.0002254873 0.001466497
## All.X.bayesglm            0.0002242344 0.0002254376 0.001466454
## All.X.no.rnorm.rpart      0.0002339146 0.0002005866          NA
## All.X.no.rnorm.rf         0.0002854799 0.0002856721          NA
```
...
![](Hyundai_Elantra2_files/figure-html/fit.models_2-1.png) 
...
![](Hyundai_Elantra2_files/figure-html/fit.models_2-2.png) 
...
## 12         All.X.no.rnorm.rf     3500.517  0.501728951               NA
## 7               Low.cor.X.lm     4423.879  0.209258716       0.47027773
## 8                   All.X.lm     4434.840  0.205335298       0.45005313
## 9                  All.X.glm     4434.840  0.205335298               NA
## 10            All.X.bayesglm     4435.817  0.204985204               NA
## 5               Max.cor.Y.lm     4442.778  0.202487973       0.50274907
## 6     Interact.High.cor.Y.lm     4442.778  0.202487973       0.50274907
## 2       Max.cor.Y.cv.0.rpart     4974.919  0.000000000               NA
## 11      All.X.no.rnorm.rpart     4985.377 -0.004208898               NA
## 1                     MFO.lm     5010.909 -0.014521109      -0.02888232
## 3  Max.cor.Y.cv.0.cp.0.rpart     5102.516 -0.051953987               NA
## 4            Max.cor.Y.rpart     5102.516 -0.051953987               NA
```
...
![](Hyundai_Elantra2_files/figure-html/fit.models_2-3.png) 
...
![](Hyundai_Elantra2_files/figure-html/fit.models_2-4.png) 
...
![](Hyundai_Elantra2_files/figure-html/fit.models_2-5.png) 

```
##    Month Year ElantraSales Unemployment Queries CPI_energy CPI_all .src
## 16     4 2011        22100          9.1     305    247.129 224.056 Test
## 4      1 2013        12174          7.9     230    242.560 231.321 Test
## 20     5 2011        20006          9.0     376    250.538 224.918 Test
## 24     6 2011        19992          9.1     371    246.401 224.990 Test
## 2      1 2011         9659          9.1     259    229.353 221.082 Test
## 34     8 2013        24700          7.2     271    244.917 233.433 Test
##    .rownames     .rnorm ElantraSales.predict.All.X.no.rnorm.rf
## 16        16  0.6886403                               15243.81
## 4          4 -0.5023235                               18118.06
## 20        20 -0.6947070                               14945.05
## 24        24  1.2079620                               14958.30
## 2          2 -0.3804710                               13242.84
## 34        34  1.5164706                               21418.05
##    ElantraSales.predict.All.X.no.rnorm.rf.err
## 16                                   6856.186
## 4                                    5944.056
## 20                                   5060.946
## 24                                   5033.700
...
## CPI_all       100.00000                    100.00000
## Unemployment   88.08331                     88.08331
## Year           53.48032                     53.48032
## CPI_energy     49.41711                     49.41711
## Queries        42.00257                     42.00257
## Month          28.25779                     28.25779
```
...
## glb_sel_mdl_id): Limiting important feature scatter plots to 5 out of 6
```

![](Hyundai_Elantra2_files/figure-html/fit.models_2-6.png) ![](Hyundai_Elantra2_files/figure-html/fit.models_2-7.png) ![](Hyundai_Elantra2_files/figure-html/fit.models_2-8.png) ![](Hyundai_Elantra2_files/figure-html/fit.models_2-9.png) ![](Hyundai_Elantra2_files/figure-html/fit.models_2-10.png) 
...
## 24                                   5033.700
## 2                                    3583.838
##    ElantraSales.predict.All.X.no.rnorm.rf.accurate .label
## 16                                           FALSE     16
## 4                                            FALSE      4
## 20                                           FALSE     20
## 24                                           FALSE     24
...
![](Hyundai_Elantra2_files/figure-html/fit.models_2-11.png) 
...
```
##         label step_major step_minor    bgn    end elapsed
## 12 fit.models          7          2 44.968 54.477   9.509
## 13 fit.models          7          3 54.478     NA      NA
```
...
```
## [1] "ElantraSales.predict.All.X.no.rnorm.rf"         
## [2] "ElantraSales.predict.All.X.no.rnorm.rf.err"     
## [3] "ElantraSales.predict.All.X.no.rnorm.rf.accurate"
```
...
![](Hyundai_Elantra2_files/figure-html/fit.models_3-1.png) 
...
```
##                label step_major step_minor    bgn    end elapsed
## 13        fit.models          7          3 54.478 57.892   3.414
## 14 fit.data.training          8          0 57.892     NA      NA
```
...
![](Hyundai_Elantra2_files/figure-html/fit.data.training_0-1.png) 
...
## 1 Final.rf           rf
##                                                     feats max.nTuningRuns
## 1 Year, CPI_all, CPI_energy, Queries, Month, Unemployment               1
##   min.elapsedtime.everything min.elapsedtime.final max.R.sq.fit
## 1                      0.898                 0.021    0.8983158
##   min.RMSE.fit max.Rsquared.fit min.RMSESD.fit max.RsquaredSD.fit
## 1     3571.411        0.6027042       561.2254          0.1008597
```
...
```
##                label step_major step_minor    bgn    end elapsed
## 14 fit.data.training          8          0 57.892 63.067   5.175
## 15 fit.data.training          8          1 63.068     NA      NA
```
...
![](Hyundai_Elantra2_files/figure-html/fit.data.training_1-1.png) 

```
##    Month Year ElantraSales Unemployment Queries CPI_energy CPI_all  .src
## 27     7 2010        18215          9.5     156    206.834 217.677 Train
## 12     3 2011        19255          9.0     281    239.454 222.955 Train
## 3      1 2012        10900          8.2     354    244.178 227.666 Train
## 14     3 2013        26153          7.5     313    244.598 232.075 Train
## 42    10 2013        14876          7.2     223    243.374 233.782 Train
## 30     7 2013        23958          7.3     274    245.926 233.252 Train
##    .rownames      .rnorm ElantraSales.predict.Final.rf
## 27        27 -0.46665535                      13688.22
## 12        12 -0.29507148                      16037.61
## 3          3  0.25331851                      13963.21
## 14        14  0.87813349                      23641.88
## 42        42 -1.07179123                      17044.93
## 30        30 -0.02854676                      22074.00
##    ElantraSales.predict.Final.rf.err
## 27                          4526.781
## 12                          3217.392
## 3                           3063.208
## 14                          2511.117
...
```
##              All.X.no.rnorm.rf.importance importance Final.rf.importance
## CPI_all                         100.00000  100.00000           100.00000
## Unemployment                     88.08331   88.08331            88.08331
## Year                             53.48032   53.48032            53.48032
## CPI_energy                       49.41711   49.41711            49.41711
## Queries                          42.00257   42.00257            42.00257
## Month                            28.25779   28.25779            28.25779
```
...
![](Hyundai_Elantra2_files/figure-html/fit.data.training_1-2.png) ![](Hyundai_Elantra2_files/figure-html/fit.data.training_1-3.png) ![](Hyundai_Elantra2_files/figure-html/fit.data.training_1-4.png) ![](Hyundai_Elantra2_files/figure-html/fit.data.training_1-5.png) ![](Hyundai_Elantra2_files/figure-html/fit.data.training_1-6.png) 
...
## 42    10 2013        14876          7.2     223    243.374 233.782 Train
##    .rownames     .rnorm ElantraSales.predict.Final.rf
## 27        27 -0.4666554                      13688.22
## 12        12 -0.2950715                      16037.61
## 3          3  0.2533185                      13963.21
## 14        14  0.8781335                      23641.88
## 42        42 -1.0717912                      17044.93
##    ElantraSales.predict.Final.rf.err .label
## 27                          4526.781     27
## 12                          3217.392     12
## 3                           3063.208      3
## 14                          2511.117     14
...
![](Hyundai_Elantra2_files/figure-html/fit.data.training_1-7.png) 
...
```
## [1] "ElantraSales.predict.Final.rf"     "ElantraSales.predict.Final.rf.err"
```
...
![](Hyundai_Elantra2_files/figure-html/fit.data.training_1-8.png) 
...
```
##                label step_major step_minor    bgn   end elapsed
## 15 fit.data.training          8          1 63.068 66.54   3.473
## 16  predict.data.new          9          0 66.541    NA      NA
```
...
![](Hyundai_Elantra2_files/figure-html/predict.data.new-1.png) 
...
![](Hyundai_Elantra2_files/figure-html/predict.data.new-2.png) ![](Hyundai_Elantra2_files/figure-html/predict.data.new-3.png) ![](Hyundai_Elantra2_files/figure-html/predict.data.new-4.png) ![](Hyundai_Elantra2_files/figure-html/predict.data.new-5.png) ![](Hyundai_Elantra2_files/figure-html/predict.data.new-6.png) 
...
![](Hyundai_Elantra2_files/figure-html/predict.data.new-7.png) 
...
```
##                   label step_major step_minor    bgn    end elapsed
## 16     predict.data.new          9          0 66.541 70.044   3.503
## 17 display.session.info         10          0 70.045     NA      NA
```
...
## 2             inspect.data          2          0  9.658 13.417   3.759
## 16        predict.data.new          9          0 66.541 70.044   3.503
## 15       fit.data.training          8          1 63.068 66.540   3.473
## 13              fit.models          7          3 54.478 57.892   3.414
## 3               scrub.data          2          1 13.417 14.703   1.287
## 5         extract.features          3          0 14.757 15.962   1.205
## 8          select.features          5          0 16.388 16.955   0.567
...
## 4     0.053
## 7     0.046
## [1] "Total Elapsed Time: 70.044 secs"
```

![](Hyundai_Elantra2_files/figure-html/display.session.info-1.png) 
